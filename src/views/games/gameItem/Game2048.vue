  ...
  export default {
    ...
    data() {
      return {
        ...
        pr: 0.9,
        score: 0,
        bestScore: localStorage.getItem('bestScore') == null || localStorage.getItem('bestScore') === undefined ? 0 : localStorage.getItem('bestScore') ,
        over: false,
        direction: [{
          x: 0,
          y: -1
        ...
        tableData: [{
          avatar: 'https://img2.woyaogexing.com/2020/09/21/820b678fae794e2d9bdb8d2157e01225!400x400.jpeg',
          name: '王小虎',
          bestScore: 999999,
        }, {
          avatar: 'https://img2.woyaogexing.com/2020/09/21/8f42eadee9ef48e689949086912783cb!400x400.jpeg',
          name: '王小虎',
          bestScore: 999989
        }, {
          avatar: 'https://img2.woyaogexing.com/2020/09/21/230d5e18ef884f7badabb7bf1680d5fa!400x400.jpeg',
          name: '王小虎',
          bestScore: 999979,
        }, {
          avatar: 'https://img2.woyaogexing.com/2020/09/21/590fa13ede8244d9924f4cd741bd02b8!400x400.jpeg',
          name: '王小虎',
          bestScore: 999969
        }]
      }
